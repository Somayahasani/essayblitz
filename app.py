# app.py — EssayBlitz FINAL PUBLIC VERSION (no sidebar, works instantly on Render)
...
# BUTTON — FIXED THE SYNTAX ERROR HERE
...
ENCOURAGEMENT: one positive sentence"""},
                ...
                formatted = fb.replace('OVERALL SCORE', '**OVERALL SCORE**') \
                             .replace('ON-TOPIC SCORE', '**ON-TOPIC SCORE**') \
                             .replace('3 QUICK FIXES', '**3 QUICK FIXES**') \
                             .replace('REWRITTEN PARAGRAPH', '**REWRITTEN PARAGRAPH**') \
